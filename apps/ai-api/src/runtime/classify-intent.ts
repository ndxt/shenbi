  ...
  return [
    {
      ...
      content: [
        ...
        'Rules:',
        '- schema.create: the user wants to generate a new page or regenerate the current page.',
        '- schema.modify: the user wants to edit an existing page schema or a selected node.',
        '- chat: the user is asking for explanation, analysis, or non-executing conversation.',
        '- If the prompt contains both create and modify signals, prefer schema.create when the user explicitly asks for a new page.',
        '- A selected node is a strong modify signal, but do not override an explicit create request.',
