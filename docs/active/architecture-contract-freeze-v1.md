...
本文档对应 `docs/active/architecture-overview.md` 第五节，作为并行开发的契约基线。
...
1. 任何契约变更必须同时更新：
`docs/active/architecture-contract-freeze-v1.md`、`packages/engine/src/types/contracts.ts`、`docs/archive/history-phase-2-plan.md`（若影响任务依赖）。
