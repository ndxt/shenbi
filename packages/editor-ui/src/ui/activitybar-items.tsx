...
function createBuiltinActivityItems(): ActivityBarItemContribution[] {
  return [
    { id: 'search', label: i18n.t('workbench.outline', { ns: 'editorUi' }), icon: Search, order: 20, active: true, section: 'main', target: { type: 'panel', panelId: 'search' } },
    { id: 'data', label: i18n.t('workbench.data', { ns: 'editorUi' }), icon: Database, order: 30, section: 'main', target: { type: 'panel', panelId: 'data' } },
