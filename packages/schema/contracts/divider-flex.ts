...
// Divider
export const dividerContract: ComponentContract = {
...
// Flex
export const flexContract: ComponentContract = {
  componentType: 'Flex',
...
// Masonry
export const masonryContract: ComponentContract = {
...
// Splitter
export const splitterContract: ComponentContract = {
...
// Splitter.Panel
export const splitterPanelContract: ComponentContract = {
