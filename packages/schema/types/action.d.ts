...
export type Action = SetStateAction | CallMethodAction | FetchAction | NavigateAction | MessageAction | NotificationAction | ConfirmAction | ModalAction | DrawerAction | ValidateAction | ResetFormAction | ConditionAction | LoopAction | ScriptAction | CopyAction | DebounceAction | ThrottleAction | BatchAction | EmitAction | CallPropAction | SetQueryAction | DownloadAction;
