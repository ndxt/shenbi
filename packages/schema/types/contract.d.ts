export declare const COMPONENT_CONTRACT_V1_VERSION: "1.0.0";
export type ContractValueType = 'string' | 'number' | 'boolean' | 'enum' | 'object' | 'array' | 'function' | 'SchemaNode' | 'Expression' | 'any';
